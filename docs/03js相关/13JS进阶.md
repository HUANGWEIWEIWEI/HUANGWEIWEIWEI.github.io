...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804181628.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804182023.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804210943.png)
...
看看函数的原型链
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804211202.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804211057.png)
...
先看一张图
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804211736.png)
...
执行前
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804211834.png)

执行后
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804211851.png)
...
先看一张图，有个大体架构
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212001.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212023.png)

以下为主线程判断逻辑

![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212126.png)
...
## [十、AMD、CMD、CommonJS与ES6模块化](../../12前端工程化/前端开发的模块化计划史.html)

[前端开发的模块化计划史](../../12前端工程化/前端开发的模块化计划史.html)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212312.png)
...
location方法
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212335.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212610.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212650.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804212709.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213335.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213409.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213500.png)

- 以上使用嵌套setTimeout来实现循环调用，可以从中看出setTimeout计时是从上一个setTimeout回调执行之后开始的，看看代码效果

![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213517.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213557.png)

- 从上图可以先得出结论，setInterval的延迟执行时间包含自身回调执行所占用的时间，看看代码效果

![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213615.png)

- 上图计算的是2次调用回调之间的间隔，不包括回调执行时间，可以看出setInterval在2次执行之间的延迟受到了回调的影响，再验证一下

![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213636.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213712.png)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200804213742.png)
...
var newArr = array.map(
  (currentValue, index, array) => { return ... }, thisValue);
```
...
```
reduce 的用途很广泛，可以说，js 中有关数组循环的模块都可以使用 reduce 来实现，这里不一一列举，详见 [reduce-MDN](https://developer.mozilla.org/zh-CN/docs/Web/JavaScript/Reference/Global_Objects/Array/Reduce)
...
![](https://gitee.com/hello_hww/img/raw/master/img1/20200807153106.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807153216.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807153805.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807154204.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807154514.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807155108.png)

![](https://gitee.com/hello_hww/img/raw/master/img1/20200807155517.png)
...
filterResult
const filterResult2=numbers.filter(isEven)
filterResult2
...
### 用reduce实现map和filter
用reduce实现map
![](https://gitee.com/hello_hww/img/raw/master/img1/20200807161539.png)
用reduce实现filter
![](https://gitee.com/hello_hww/img/raw/master/img1/20200807163109.png)

```js
function map(project,arr){
    return reduce(
        (prev,curr)=>[...prev,project(curr)],[],arr
    )
}

function filter(predict,arr) {
    return reduce(
        (prev,curr)=>(predict(curr)?[...prev,curr]:prev),[],arr)
...
[5102的技术文档](https://docs.5102it.cn/js/JS-Depth.html)
